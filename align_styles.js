...
function alignCaseStudy(file) {
    ...
    // Align h2 headings
    content = content.replace(/className="text-2xl md:text-4xl font-bold text-text-primary mb-4"/g, 'className="text-2xl md:text-3xl lg:text-4xl font-black tracking-tight text-text-primary mb-4"');
